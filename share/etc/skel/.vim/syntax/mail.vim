...
syn match mailQuoted1	"^>[^>].*" contains=langIdentifier,langConstant

source ~/.vim/syntax/mdiff.vim
...
hi def link mailQuoted1		Question
hi def link mailQuoted2		Keyword
hi def link mailQuoted3		Comment
hi def link mailQuoted4		Number
hi def link mailQuoted5		mailQuoted2
hi def link mailQuoted6		mailQuoted3
