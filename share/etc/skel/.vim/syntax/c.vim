...
" by wfg
syn keyword	cLock		spin_lock spin_unlock spin_lock_irq spin_unlock_irq spin_lock_irqsave spin_unlock_irqrestore spin_lock_bh spin_unlock_bh spin_trylock spin_trylock_irq spin_trylock_irqsave spin_trylock_bh spin_lock_nested spin_lock_nest_lock spin_lock_irqsave_nested assert_spin_locked mutex_lock mutex_unlock
" syn match	cLock		"^(spin_lock\|spin_unlock).*$"
syn match	cMacro		"\<[A-Z_]\+\>"
hi def link cLock		SpellRare
hi def link cMacro		Number
